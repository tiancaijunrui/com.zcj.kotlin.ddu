...
//        val auth = Authenticator()
        val session = getDefaultInstance(properties, LoginAuthenticator("zcj984453536@126.com","zcj984453536??"))
        val message = MimeMessage(session)
        message.setFrom(InternetAddress("zcj984453536@126.com"))
        ...
        transport.connect(properties.get("mail.smtp.host").toString(),25,"zcj984453536@126.com","zcj19921123??")
